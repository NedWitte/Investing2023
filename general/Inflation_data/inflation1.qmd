...
## Python code within Rstudio Quarto qmd file test
...
plt.plot(inflation_data.index, inflation_data['CPIAUCSL'], color='b', label='CPI Inflation')
plt.title('Consumer Price Index (CPI) Inflation Over Time')
plt.xlabel('Year')
...
And this a the CPI chart using python code:
